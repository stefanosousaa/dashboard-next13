                ...
                {data.map((order,id) => (
                    <li key={id} className='bg-gray-50 hover:bg-gray-100 rounded-lg my-3 p-2 grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 items-center justify-between cursor-pointer'>
                      ...
                      <div className='sm:flex hidden justify-between items-center'>
                        <p>{order.method}</p>
                        <button className='bg-yello-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>Editar</button>
                        <button className='bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>Excluir</button>
                      </div>
                    </li>
                ))}
              </ul>
